...
# 15 "MCAL_Layer/Timer0/../GPIO/../mcal_std_types.h"
...
# 15 "MCAL_Layer/Timer0/../GPIO/../mcal_std_types.h" 2

# 1 "MCAL_Layer/Timer0/../GPIO/../Compiler.h" 1
# 16 "MCAL_Layer/Timer0/../GPIO/../mcal_std_types.h" 2
# 37 "MCAL_Layer/Timer0/../GPIO/../mcal_std_types.h"
...
# 40 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 54 "MCAL_Layer/Timer0/../interrupt/mcal_interrupt_cfg.h"
typedef enum{
...
# 9 "MCAL_Layer/Timer0/hal_timer0.c" 2
...
# 31 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType timer0_init(const timer0_t *_timer){
...
# 74 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType timer0_deinit(const timer0_t *_timer){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) == _timer){
        ret = (Std_ReturnType)0x00;
...
# 99 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType timer0_write_value(const timer0_t *_timer, uint16 _value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) == _timer){
        ret = (Std_ReturnType)0x00;
...
# 122 "MCAL_Layer/Timer0/hal_timer0.c"
Std_ReturnType timer0_read_value(const timer0_t *_timer, uint16 *_value){
    Std_ReturnType ret = (Std_ReturnType)0x00;
...
# 146 "MCAL_Layer/Timer0/hal_timer0.c"
static __attribute__((inline)) void timer0_prescaler_config(const timer0_t *_timer){
...
# 191 "MCAL_Layer/Timer0/hal_timer0.c"
void TMR0_ISR(void){
    (INTCONbits.TMR0IF = 0);
