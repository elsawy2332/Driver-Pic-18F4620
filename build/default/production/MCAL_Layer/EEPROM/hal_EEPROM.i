...
# 37 "MCAL_Layer/EEPROM/../mcal_std_types.h"
...
# 40 "MCAL_Layer/EEPROM/../interrupt/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 54 "MCAL_Layer/EEPROM/../interrupt/mcal_interrupt_cfg.h"
typedef enum{
...
# 65 "MCAL_Layer/EEPROM/hal_EEPROM.c"
Std_ReturnType EEPROM_ReadByte(uint16 bAdd, uint8 *bData){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) == bData){
